...
# models
m_ancelin <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_ancelin)+ sqrt(aa_ancelin_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_boustani <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_boustani)+ sqrt(aa_boustani_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_carnahan <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_carnahan)+ sqrt(aa_carnahan_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_cancelli <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_cancelli)+ sqrt(aa_cancelli_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_chew <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_chew)+ sqrt(aa_chew_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_rudolph <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_rudolph)+ sqrt(aa_rudolph_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_ehrt <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_ehrt)+ sqrt(aa_ehrt_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_han <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_han)+ sqrt(aa_han_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_sittironnarit <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_sittironnarit)+ sqrt(aa_sittironnarit_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_briet<- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_briet)+ sqrt(aa_briet_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_bishara <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_bishara)+ sqrt(aa_bishara_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_duran <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_duran)+ sqrt(aa_duran_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_kiesel <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_kiesel)+ sqrt(aa_kiesel_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_ancelin_n <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_ancelin_n)+ sqrt(aa_ancelin_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_boustani_n <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_boustani_n)+ sqrt(aa_boustani_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_carnahan_n <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_carnahan_n)+ sqrt(aa_carnahan_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_cancelli_n <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_cancelli_n)+ sqrt(aa_cancelli_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_chew_n <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_chew_n)+ sqrt(aa_chew_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_rudolph_n <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_rudolph_n)+ sqrt(aa_rudolph_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_ehrt_n <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_ehrt_n)+ sqrt(aa_ehrt_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_han_n <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_han_n)+ sqrt(aa_han_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_sittironnarit_n <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_sittironnarit_n)+ sqrt(aa_sittironnarit_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_briet_n <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_briet_n)+ sqrt(aa_briet_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_bishara_n <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_bishara_n)+ sqrt(aa_bishara_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_duran_n <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_duran_n)+ sqrt(aa_duran_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_kiesel_n <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_kiesel_n)+ sqrt(aa_kiesel_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_ancelin_ddd_dose <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_ancelin_ddd_dose)+ sqrt(aa_ancelin_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_boustani_ddd_dose <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_boustani_ddd_dose)+ sqrt(aa_boustani_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_carnahan_ddd_dose <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_carnahan_ddd_dose)+ sqrt(aa_carnahan_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_cancelli_ddd_dose <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_cancelli_ddd_dose)+ sqrt(aa_cancelli_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_chew_ddd_dose <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_chew_ddd_dose)+ sqrt(aa_chew_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_rudolph_ddd_dose <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_rudolph_ddd_dose)+ sqrt(aa_rudolph_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_ehrt_ddd_dose <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_ehrt_ddd_dose)+ sqrt(aa_ehrt_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_han_ddd_dose <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_han_ddd_dose)+ sqrt(aa_han_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_sittironnarit_ddd_dose <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_sittironnarit_ddd_dose)+ sqrt(aa_sittironnarit_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_briet_ddd_dose <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_briet_ddd_dose)+ sqrt(aa_briet_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_bishara_ddd_dose <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_bishara_ddd_dose)+ sqrt(aa_bishara_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_duran_ddd_dose <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_duran_ddd_dose)+ sqrt(aa_duran_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_kiesel_ddd_dose <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(aa_kiesel_ddd_dose)+ sqrt(aa_kiesel_poly) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_poly_simple <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(poly_cov) + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)
m_poly <- coxph(data=id_years, Surv(person_time, dementia) ~ scale(poly_cov) + aa_any + sex + data_provider + med_age + year + education + deprivation + bmi_class +   smoking + alc_freq + activity + comorbidity + depression+stroke + diabetes+hyperchol+hypertension+apoe_carrier)