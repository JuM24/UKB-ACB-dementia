# -*- coding: utf-8 -*-
"""
Created on Fri Mar 12 09:37:22 2021
...
# create separate columns indicating which class (0-2) the anticholinergic belongs to
meds['aa_duran_0'] = 0
meds['aa_duran_05'] = 0
meds['aa_duran_1'] = 0
meds['aa_duran_2'] = 0
meds.loc[meds['aa_duran']==0, 'aa_duran_0'] = 1
meds.loc[meds['aa_duran']==0.5, 'aa_duran_05'] = 1
meds.loc[meds['aa_duran']==1, 'aa_duran_1'] = 1
meds.loc[meds['aa_duran']==2, 'aa_duran_2'] = 1
# and this is for the anticholinergic burden due to different groups/levels of anticholinergic drugs
meds['aa_duran_0_value'] = 0
meds['aa_duran_05_value'] = 0
meds['aa_duran_1_value'] = 0
meds['aa_duran_2_value'] = 0
meds.loc[meds['aa_duran']==0.5, 'aa_duran_05_value'] = 0.5
meds.loc[meds['aa_duran']==1, 'aa_duran_1_value'] = 1
meds.loc[meds['aa_duran']==2, 'aa_duran_2_value'] = 2
...
id_years = meds.groupby(['id','year'], as_index=True).agg(meds_count=('id','count'),
                                                          aa_0_count=('aa_duran_0','sum'),
                                                          aa_0_value=('aa_duran_0_value','sum'),
                                                          aa_05_count=('aa_duran_05','sum'),
                                                          aa_05_value=('aa_duran_05_value','sum'),
                                                          aa_1_count=('aa_duran_1','sum'),
                                                          aa_1_value=('aa_duran_1_value','sum'),
                                                          aa_2_count=('aa_duran_2','sum'),
                                                          aa_2_value=('aa_duran_2_value','sum')).unstack(fill_value=0).stack()
...
id_years = id_years[['id', 'year', 'data_provider', 'meds_count', 'aa_0_count', 'aa_0_value', 'aa_05_count', 'aa_05_value',
                             'aa_1_count', 'aa_1_value', 'aa_2_count', 'aa_2_value', 'med_age',
                             'date_first', 'date_last', 'first_year', 'last_year', 'sex', 'month_len', 'birth_date', 
                             'date_1', 'date_2', 'date_3', 'centre', 'date', 'education', 'deprivation', 'smoking', 'alc_freq',
                             'activity', 'bmi']]

# export .csv
prescriptions = id_years.to_csv('id_years_aa_groups_v2.csv', header=True, sep='|')
